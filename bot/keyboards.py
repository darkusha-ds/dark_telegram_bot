...
teachers0 = types.KeyboardButton('/{}'.format(g_back))
teachers1 = types.KeyboardButton('/{}'.format(g_math))
teachers2 = types.KeyboardButton('/{}'.format(g_cher4enie))
teachers3 = types.KeyboardButton('/{}'.format(g_fizra))
teachers4 = types.KeyboardButton('/{}'.format(g_management))
