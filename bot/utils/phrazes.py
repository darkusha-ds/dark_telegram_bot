...
english = ['английский_язык', 'Английский_язык', 'Английский']
informatika = ['информатика', 'Информатика']
fizika = ['Физика', 'физика']
filosof = ['Философия', 'философия']
algoritm = ['Основы_алгоритмизации', 'основы_алгоритмизации', 'Алгоритмизация', 'алгоритмизация']
uir = ['УИР', 'уир']
